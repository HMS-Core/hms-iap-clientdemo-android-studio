...
public class IapRequestHelper {
    ...
    private static PurchaseIntentWithPriceReq createPurchaseIntentWithPriceReq(ProductItem productItem) {
        ...
        req.setCountry(productItem.getCountry());
        return req;
    }
    ...
    /**
     *
     * Create orders for in-app products not in IAP PMS.
     * You need to specify the price of the product instead of obtaining the price from IAP PMS.
     *
     * @param iapClient IapClient instance to call the createPurchaseIntentWithPrice API.
     * @param productItem In-app product to be paid.
     * @param callback IapApiCallback
     */
    public static void createPurchaseIntentWithPrice(final IapClient iapClient, ProductItem productItem, final IapApiCallback callback) {
